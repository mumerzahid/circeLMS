...
class VisitScreenView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<VisitScreenViewModel>.reactive(
      builder: (context, model, child) => model.visits.isEmpty || model.visits.length == null? Center(
        child: Container(
          child: Text("No visits today!",style: TextStyle(
        ...
        body: model.isLoading?Center(child: CircularProgressIndicator()):RefreshIndicator(
            ...
            child:Column(
              children: [
                ...
                model.isLoading?CircularProgressIndicator():ListView.builder(
                    ...
                    itemCount: model.visits.length == 0 || model.visits == null ? 0: model.visits.length,
