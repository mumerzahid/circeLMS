...
class VisitScreenView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<VisitScreenViewModel>.reactive(
      builder: (context, model, child) => model.screenLoading?Center(child: CircularProgressIndicator()):model.visits.isEmpty ||
              model.visits.length == null
          ? RefreshIndicator(
          ...
          : model.screenLoading? Center(child: CircularProgressIndicator()):Scaffold(
                          ...
                          children: [
                            ...
                            model.isLoading
                                ...
                                : ListView.builder(
                                    ...
                                    itemCount: model.visits.length == 0 ||
                                            model.visits == null
                                        ? 0
                                        : model.visits.length,
